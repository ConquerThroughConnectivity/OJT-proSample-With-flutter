...
class _MyHomePageState extends State<MyHomePage> {
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            FloatingActionButton(
                              ...
                              child: Image(
                                image: NetworkImage(
                                    'https://4.bp.blogspot.com/-ELGjUUP9ySM/XDc1M1bfkJI/AAAAAAAAGts/w8pbqBzOnOYdRIiBk8wqwvmkOiKzDyp1wCK4BGAYYCw/s1600/logo%2Bfacebook.png'),
                                fit: BoxFit.fill,
                              ),
                              heroTag: 'facebook',
                              mini: true,
                            ...
                            FloatingActionButton(
                              ...
                              child: Image(
                                image: NetworkImage(
                                    'https://cdn3.iconfinder.com/data/icons/free-social-icons/67/twitter_circle_color-512.png'),
                                fit: BoxFit.fill,
                              ),
                              heroTag: 'twitter',
                              mini: true,
  ...
  signup() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => Sign(), fullscreenDialog: true));
  }
}
